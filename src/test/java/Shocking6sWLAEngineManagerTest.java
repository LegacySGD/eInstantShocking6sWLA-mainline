...
public class Shocking6sWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Shocking6sWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Shocking6sWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Shocking6sWLAIW/InitOutcome.xml").getDocumentElement();
